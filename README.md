...
If you would like a standardized package of the core of this technology for use with ANY type of project, simply download git and Temporal, or Kubernetes and Temporal to build your own implemntation around your needs. The beauty is that they are both free and opensource software, but they aren't being used this way. Use This as an example of what's possible in systems with real LLMs and your modern codebases. You'll be able to modify your infrastructure and even software with declaritive text like Terraform. Also, you're be able to let APIs
